...
EXPANSION.push(
  cocktail({
    ...
    ingredients: [
      ing("rum-white", "Light Puerto Rican rum", "spirit", 60),
      ing("triple-sec", "Cointreau or curaçao", "liqueur", 15),
      ing("orange-juice", "Orange juice", "juice", 60),
      ing("lemon-juice", "Lemon juice", "juice", 30),
      ing("rock-candy-syrup", "Rock candy syrup", "syrup", 7.5),
      ing("orgeat", "Orgeat", "syrup", 7.5),
    ],
    ...
    preparation: [
      "Shake all ingredients with ice.",
      "Strain into a sling glass filled with crushed ice.",
      "Garnish with mint.",
    ],
  }),
  cocktail({
    ...
    garnish: ["Lemon wedge", "cocktail umbrella"],
    preparation: [
      "Flash-blend all ingredients with crushed ice and a few agitator cubes (3–4 seconds).",
      "Open-pour into a zombie or tiki mug.",
      "Garnish with lemon and an inside-out cocktail umbrella.",
    ],
  }),
  cocktail({
    ...
    tags: ["tiki", "classic-tiki"],
    ingredients: [
      ing("rum-dark", "Dark Jamaican rum", "spirit", 45),
      ing("rum-white", "Light Puerto Rican rum", "spirit", 45),
      ing("orange-juice", "Orange juice", "juice", 90),
      ing("lemon-juice", "Lemon juice", "juice", 60),
      ing("passion-fruit-syrup", "Passion fruit syrup", "syrup", 30),
      ing("simple-syrup", "Simple syrup", "syrup", 30),
    ],
    garnish: ["Mint sprig", "lemon peel"],
    preparation: [
      "Shake all ingredients with ice.",
      "Pour unstrained into a large snifter and add more ice to fill.",
      "Garnish with mint and a long lemon peel.",
    ],
  }),
  cocktail({
    name: "QB Cooler",
    ...
    tags: ["tiki", "classic-tiki"],
    ingredients: [
      ing("rum-dark", "Gold Jamaican rum", "spirit", 30),
      ing("rum-white", "Light Puerto Rican rum", "spirit", 30),
      ing("demerara-rum", "Demerara rum", "spirit", 15),
      ing("orange-juice", "Orange juice", "juice", 30),
      ing("lime-juice", "Lime juice", "juice", 15),
      ing("honey-syrup", "Honey mix (1:1 honey and water)", "syrup", 15),
      ing("falernum", "Falernum", "liqueur", 7.5),
      ing("ginger-syrup", "Ginger syrup", "syrup", 2.5),
      ing("club-soda", "Club soda", "mixer", 30),
      ing("angostura-bitters", "Angostura bitters", "bitters", 2, "dash"),
    ],
    garnish: ["Mint sprig"],
    preparation: [
      "Add all ingredients and about 120 ml crushed ice to a blender.",
      "Blend on high for 5 seconds.",
      "Pour unstrained into a double old-fashioned glass, top with more crushed ice, and garnish with mint.",
    ],
  }),
  cocktail({
    ...
    ingredients: [
      ...
      ing("rum-dark", "Dark Jamaican rum", "spirit", 30),
      ing("lime-juice", "Lime juice", "juice", 22.5),
      ing("grapefruit-juice", "White grapefruit juice", "juice", 15),
      ing("simple-syrup", "Simple syrup (1:1)", "syrup", 15),
      ing("pimento-dram", "Allspice dram", "liqueur", 7.5),
    ],
    garnish: ["Scored lime wedge", "mint sprig"],
    preparation: [
      "Shake all ingredients with ice.",
      "Strain into a double old-fashioned glass filled with crushed ice.",
      "Garnish with mint and a scored lime wedge.",
    ],
  }),
  cocktail({
    name: "151 Swizzle",
    slug: "151-swizzle",
    glass: "Swizzle cup or pilsner",
    family: "Tiki",
    method: "Blend",
    tags: ["tiki", "classic-tiki"],
    ingredients: [
      ing("overproof-rum", "151-proof Demerara rum", "spirit", 45),
      ing("lime-juice", "Lime juice", "juice", 15),
      ing("simple-syrup", "Simple syrup", "syrup", 15),
      ing("absinthe", "Pernod or absinthe", "liqueur", 1, "dash"),
      ing("angostura-bitters", "Angostura bitters", "bitters", 1, "dash"),
    ],
    garnish: ["Grated nutmeg", "cinnamon stick"],
    preparation: [
      "Add all ingredients and about 240 ml crushed ice to a blender.",
      "Flash-blend on high for no more than 5 seconds.",
      "Pour unstrained into a tall swizzle cup, top with crushed ice, and dust with nutmeg.",
