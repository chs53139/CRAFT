...
const KNOWN_HISTORY = {
  ...
  "tradewinds": {
    year: 1970,
    region: "Caribbean (documented origin uncertain)",
    source: "Beachbum Berry Remixed (Jeff Berry)",
    fact: "Berry prints Tradewinds as a large-format punch from the Caribbean circa the 1970s; modern bars usually flash-blend a single serving with two rums, apricot, coconut, and lemon.",
  },
  ...
  "potted-parrot": {
    ...
    source: "Victor Bergeron (Trader Vic's Bartender's Guide)",
    fact: "Trader Vic's Potted Parrot is a light-rum sling with orange and lemon, curaçao, orgeat, and rock-candy syrup—adapted from Bergeron's bartender's guide. The name nods to Polly, a parrot kept at the original Trader Vic's.",
  },
  "chief-lapu-lapu": {
    year: 1955,
    region: "United States (Polynesian-pop tiki bars)",
    source: "Beachbum Berry Remixed (mid-century menu formula)",
    fact: "Chief Lapu Lapu takes its name from the Filipino ruler Lapu Lapu; Berry documents a large-format rum-and-citrus punch with passion fruit, though menus and bars still disagree on details.",
  },
  "qb-cooler": {
    year: 1937,
    region: "Hollywood, California, USA",
    source: "Donn Beach (Don the Beachcomber); Jeff Berry, Sippin' Safari / Remixed",
    fact: "Don the Beachcomber's Q.B. Cooler—'Q.B.' for the Quiet Birdmen pilots' society—layers three rums, citrus, honey mix, falernum, ginger, and bitters; Berry recovered the formula from former Beachcomber staff.",
  },
  "ancient-mariner": {
    year: 1994,
    region: "Los Angeles, California, USA",
    source: "Jeff Berry & Annene Kaye (Grog Log, 1998; Remixed, 2010)",
    fact: "Berry and Kaye built the Ancient Mariner as a Navy Grog–style sour with Demerara and Jamaican rum, grapefruit, lime, simple syrup, and allspice dram—the title riffs on Coleridge's poem.",
  },
  "151-swizzle": {
    year: 1960,
    region: "Hollywood, California, USA",
    source: "Don the Beachcomber; Jeff Berry Remixed",
    fact: "Don the Beachcomber's 151 Swizzle is a flash-blended overproof Demerara daiquiri with a few drops of anise liqueur and Angostura—served in a metal swizzle cup with nutmeg, not falernum.",
  },
};
